...
def initialize_parameters(tool):
    ...
    tm = Sequential()
    tm.add(GlobalAveragePooling2D(input_shape=tool.features_shape(tool.instantiate_base_model(model_name=model_attributes['base_model'],
